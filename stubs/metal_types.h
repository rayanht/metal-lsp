...
template <typename T> vec2<T> operator*(T a, vec2<T> b) { return {T(a*b.x), T(a*b.y)}; }
template <typename T> vec2<T> operator+(T a, vec2<T> b) { return {T(a+b.x), T(a+b.y)}; }
template <typename T> vec2<T> operator-(T a, vec2<T> b) { return {T(a-b.x), T(a-b.y)}; }
template <typename T> vec2<T> operator/(T a, vec2<T> b) { return {T(a/b.x), T(a/b.y)}; }
...
template <typename T> vec3<T> operator*(T a, vec3<T> b) { return {T(a*b.x), T(a*b.y), T(a*b.z)}; }
template <typename T> vec3<T> operator+(T a, vec3<T> b) { return {T(a+b.x), T(a+b.y), T(a+b.z)}; }
template <typename T> vec3<T> operator-(T a, vec3<T> b) { return {T(a-b.x), T(a-b.y), T(a-b.z)}; }
template <typename T> vec3<T> operator/(T a, vec3<T> b) { return {T(a/b.x), T(a/b.y), T(a/b.z)}; }
...
template <typename T> vec4<T> operator*(T a, vec4<T> b) { return {T(a*b.x), T(a*b.y), T(a*b.z), T(a*b.w)}; }
template <typename T> vec4<T> operator+(T a, vec4<T> b) { return {T(a+b.x), T(a+b.y), T(a+b.z), T(a+b.w)}; }
template <typename T> vec4<T> operator-(T a, vec4<T> b) { return {T(a-b.x), T(a-b.y), T(a-b.z), T(a-b.w)}; }
template <typename T> vec4<T> operator/(T a, vec4<T> b) { return {T(a/b.x), T(a/b.y), T(a/b.z), T(a/b.w)}; }
